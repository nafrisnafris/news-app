...
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;

-- Dumping data for table news-app.users
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT IGNORE INTO `users` (`username`, `email`, `password`, `permission`, `verify_token`, `is_active`, `forgot_token`, `forgot_token_expire`, `created_at`, `updated_at`) VALUES
	('Super Admin', 'admin@gmail.com', '$2y$10$XFiZdc8EzBtSP4BBgONAjO9YjWMcZFqoGT/oWxUbHusgvuY0xV6q6', 'user', NULL, 0, NULL, NULL, '2019-06-06 01:28:40', '2019-10-27 21:59:41'),
	('a', 'a', '$2y$10$ynAZWR3vhm84p0zSLA9piOlKSy4QDaGnTdYGh2ODTUjzBQud6z/Li', 'user', NULL, 1, NULL, NULL, '2021-06-23 23:35:51', '2019-07-05 02:10:50');
...
-- Dumping data for table news-app.categories: ~4 rows (approximately)
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
INSERT IGNORE INTO `categories` (`name`, `created_at`, `updated_at`) VALUES
	('Technology', '2022-10-24 09:26:37', '2022-10-24 09:26:43'),
	('Business', '2022-10-24 09:36:05', '2023-02-05 08:38:59'),
	('Sports', '2022-10-24 09:49:39', '2023-02-05 08:39:01'),
	('Science', '2022-10-24 10:00:18', '2023-02-05 08:39:02');
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;

-- Dumping structure for table news-project.posts
